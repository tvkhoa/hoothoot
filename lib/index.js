...
exports.deepUpdate = exports.normalizedUpdateFunction = exports.deepSet = exports.normalizedSetFunction = exports.deepGet = exports.normalizedGetFunction = exports.getDeepPath = exports.normalizePath = exports.parsePathElement = exports.detectArrayOfObject = undefined;
...
var parsePathElement = exports.parsePathElement = function parsePathElement(pathElement) {
  if (detectArrayOfObject(pathElement)) {
    ...
    var key = elements[0];
    var selector = (0, _lodash.split)(objectString, '=')[0];
...
var normalizePath = exports.normalizePath = function normalizePath(origin) {
  ...
  var magicRegex = new RegExp(/\.(?![^[]*\])/, 'g');

  var pathElements = (0, _lodash.split)(path, magicRegex);
  var newValue = (0, _lodash.reduce)(pathElements, function (result, pathElement) {
    ...
    if (detectArrayOfObject(pathElement)) {
      var _parsePathElement = parsePathElement(pathElement),
          ...
          selector = _parsePathElement.selector,
      ...
      var newIndex = (0, _lodash.findIndex)(valueFromKey, function (objectInArray) {
        return (0, _lodash.isEqual)((0, _lodash.toString)((0, _lodash.get)(objectInArray, selector)), value);
      });
...
var getDeepPathFunction = function getDeepPathFunction(path, origin) {
  return normalizePath(origin, path);
};

var getDeepPath = exports.getDeepPath = (0, _lodash.curry)(getDeepPathFunction);
...
var deepGet = exports.deepGet = (0, _lodash.curry)(normalizedGetFunction);
...
var deepSet = exports.deepSet = (0, _lodash.curry)(normalizedSetFunction);
...
var deepUpdate = exports.deepUpdate = (0, _lodash.curry)(normalizedUpdateFunction);
